			...
			<form action="edit_ok.jsp" method="post" enctype="multipart/form-data" >
				<table summary="게시판 글쓰기">
					...
					<tbody>
						<tr>
							<th>Date :</th>
							<td><p>Today's date: <%= vo.getWrite_date()%></p></td>
						</tr>
						<tr>
							<th>제목:</th>
							<td><input type="text" id="subject" name="subject" size="45" value="<%=vo.getSubject() %>" /></td>
						</tr>
						<tr>
							<th>이름:</th>
							<td><input type="text" id="writer" name="writer" size="12" value="<%=vo.getWriter() %>" readonly /></td>
						</tr>
						<tr>
							<th>내용:</th>
...
<%	} %>
	...
	<script type="text/javascript">
		...
		function sendData(){
			...
			document.forms[0].action = "edit_ok.jsp";
