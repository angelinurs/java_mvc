...
<html>
	<head>
		...
		<link rel="stylesheet" href="bbs/css/summernote-lite.css">
	...
	<body>
		<div id="bbs">
			...
			-->
			<form action="bbsCon?type=write" method="post" 
	...
	<script type="text/javascript">
		...
		function backList()	{
			location.href = "bbsCon?type=list&cPage=${cPage} ";
		}
